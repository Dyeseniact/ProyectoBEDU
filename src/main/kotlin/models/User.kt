...
class User(id:Int, nombre:String, userName:String, password:String, private  var email: String, private var accountType:String="user",
           var preferredGenre: ArrayList<MutableSet<String>> = arrayListOf()) : Person(id, nombre, userName, password) {

    fun getEmail():String = email
    fun getAccount():String = accountType
